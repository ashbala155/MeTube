...
$('.user__name').each(function() {
    var str = $(this).text();
    var matches = str.match(/\b(\w)/g);
    var acronym = matches.join('');
    $(this).prepend('<span>' + acronym + '</span>')
  })

  $('.my__name').each(function() {
    var str = $(this).text();
    var matches = str.match(/\b(\w)/g);
    var acronym = matches.join('');
    $(this).prepend('<span>' + acronym + '</span>')
...
// //rating
// let stars = Array.from(document.querySelectorAll(".rating a"));
